...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def saveLabels(self, annotationFilePath):
        ...
        for data in shapes:
            f.write('{0},{1},{2},{3},{4},{5},{6},{7},{8}\n'.format(int(data['points'][0][0]), int(data['points'][0][1]), int(data['points'][1][0]), int(data['points'][1][1]), int(data['points'][2][0]), int(data['points'][2][1]), int(data['points'][3][0]), int(data['points'][3][1]), data['label']))
        f.close()
        return True
    ...
    def saveFile(self, _value=False):
        if self.defaultSaveDir is not None and len(ustr(self.defaultSaveDir)):
            if self.filePath:
                ...
                savedFileName = "gt_%s"%os.path.splitext(imgFileName)[0]
